...
<head>
    ...
    <title>User Login | KeyPoint</title>
...
<body class="bg-blue-100">
    <section class="py-5 sm:py-5 lg:py-10">
                    ...
                    <div class="px-4 py-6 sm:px-8 sm:py-7">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="#" title=""
                                            class="text-sm font-medium text-blue-500 transition-all duration-200 hover:text-orange-600 focus:text-orange-600 hover:underline">
                                            Forgot password?
                                        </a>
                                    </div>
                                    <div class="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                        ...
                        <div class="text-center">
                            <p class="text-base text-gray-600">
                                ...
                                <a href="{{ route('user.registration') }}" title=""
                                    class="font-medium text-blue-500 transition-all duration-200 hover:text-orange-600 hover:underline">Create
                                    a free account</a>
                            </p>
                        </div>
                    </div>
