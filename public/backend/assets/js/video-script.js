...
video_players.forEach(video_player => {
  ...
  <div class="controls active">
    <div class="progress-area" style="visibility: hidden;">
  ...
  <div class="captions">
    ...
    mainVideo.addEventListener("timeupdate", (e) => {
        ...
        // for blade
        let bladeCurrentVideoTime = Math.floor(e.target.currentTime);

        document.getElementById("current_video_time").textContent = `${bladeCurrentVideoTime} seconds`;
